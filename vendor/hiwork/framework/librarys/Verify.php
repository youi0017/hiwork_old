...
class Verify
{
	 ...
	 * @return boolean
	 */
    public static function isUsr(&$v, $minLen=3, $maxLen=16)
    {
	    $v = trim($v);
        if(!$v) return false;
     ...
     * @return boolean
     */
    public static function isPwd(&$v, $minLen=3,$maxLen=16)
    {
	    /*
     ...
     * @return boolean
     */
    public static function isTelephone(int $v)
    {
	    if(!is_numeric($v) || !$v) return false;
    ...
    public static function isQQ(int $v)
    {
        $match='/^[1-9][0-9]{4,}$/';
        return preg_match($match,$v);   
    }
